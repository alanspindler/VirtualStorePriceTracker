...
namespace Database
{
    ...
    {
        public int Id { get; set; }
        public string Origin { get; set; } // Código IATA do aeroporto de origem
        public string Destination { get; set; } // Código IATA do aeroporto de destino
        public DateTime OutboundDate { get; set; } // Data da ida
        public DateTime? InboundDate { get; set; } // Data da volta (opcional)
        public int NumberOfAdults { get; set; } // Número de adultos
        public int NumberOfChildren { get; set; } = 0; // Número de crianças, padrão 0
        public int NumberOfInfants { get; set; } = 0; // Número de bebês, padrão 0
        public string TripType { get; set; } // Tipo de viagem ("OW" ou "RT")
        public string Cabin { get; set; } = "Economy"; // Tipo de cabine, padrão "Economy"
        public bool Redemption { get; set; } = false; // Sempre false
        public string Sort { get; set; } = "RECOMMENDED"; // Sempre "RECOMMENDED"
        public decimal? CheapestPrice { get; set; } // Preço mais econômico atual
        public decimal? FastestPrice { get; set; } // Preço mais rápido atual
    }
